<?
	...
	if ($startdate != "" && $enddate != "") {
		$query = "SELECT accepteddate, pickupdate FROM tickets WHERE accepteddate LIKE '%-%-%' AND pickupdate LIKE '%-%-%' AND accepteddate >= '$startdate' AND pickupdate <= '$enddate';";
	}
	else {
...
<table width="100%">
	<tr>
		<td align="right" colspan="2">
			<form enctype="multipart/form-data" method="post" action="chart2.php">
...
<table>
	...
	<?}?>
	<tr>
		<td><b>Average Life Of Ticket:</td><td><?echo round($averagetime, 2); ?> days</b></td>
	</tr>
	<tr>
		<td><b>Average Pickup Time:</td><td><?echo round($averagepickuptime, 2); ?> days</b></td>
	</tr>
</table>
<br>
