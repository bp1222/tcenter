...
if( $search ) {
  ...
  $query = "SELECT tickets.accepteddate, tickets.tcnumber, tickets.summary, tickets.lastupdateddate, tickets.lastupdatedby, machines.description FROM tickets, machines WHERE tickets.tcnumber = machines.tcnumber AND ( tickets.status = 'Queued' OR tickets.status = 'Re-Queued' ) AND tickets.queue = 'Resnet' ORDER BY tickets.statusoverride DESC, tickets.statustime ASC, tickets.tid ASC;";
  $result = pg_query( $query );
  $numrows = pg_num_rows( $result );
  ...
  $query = "SELECT tickets.accepteddate, tickets.tcnumber, tickets.summary, tickets.lastupdateddate, tickets.lastupdatedby, machines.description FROM tickets, machines WHERE tickets.tcnumber = machines.tcnumber AND tickets.status = 'Pending Customer' AND tickets.queue = 'Resnet' ORDER BY tickets.statusoverride DESC, tickets.statustime ASC, tickets.tid ASC;";
  $result = pg_query( $query );
  $numrows = pg_num_rows( $result );
  ...
  $query = "SELECT tickets.accepteddate, tickets.tcnumber, tickets.summary, tickets.lastupdateddate, tickets.lastupdatedby, machines.description FROM tickets, machines WHERE tickets.tcnumber = machines.tcnumber AND tickets.status = 'Awaiting Pickup' AND tickets.queue = 'Resnet' ORDER BY tickets.statusoverride DESC, tickets.statustime ASC, tickets.tid ASC;";
  $result = pg_query( $query );
  $numrows = pg_num_rows( $result );
  ...
  $query = "SELECT tickets.accepteddate, tickets.tcnumber, tickets.summary, tickets.lastupdateddate, tickets.lastupdatedby, machines.description FROM tickets, machines WHERE tickets.tcnumber = machines.tcnumber AND tickets.status = 'Administrative Hold' AND tickets.queue = 'Resnet' ORDER BY tickets.statusoverride DESC, tickets.statustime ASC, tickets.tid ASC;";
  $result = pg_query( $query );
  $numrows = pg_num_rows( $result );
  ...
  $query = "SELECT tickets.accepteddate, tickets.tcnumber, tickets.summary, tickets.lastupdateddate, tickets.lastupdatedby, machines.description FROM tickets, machines WHERE tickets.tcnumber = machines.tcnumber AND tickets.status = 'New' ORDER BY tickets.statusoverride DESC, tickets.statustime ASC, tickets.tid ASC;";
  $result = pg_query( $query );
  $numrows = pg_num_rows( $result );
