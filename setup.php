		...
		<div class="boxContent">
			<fieldset>
				...
				<label class="fLblRequest" for="serverHostname"><span class="required">*</span>MySQL Hostname: </label>
					<input type="text" name="serverHostname" value="<?=$hostname ? $hostname : "localhost"?>" size="20" maxlength="30"
						onclick="clearField(this)"/>
	
				<label class="fLblRequest"><span class="required">*</span>MySQL Username: </label>
					<input type="text" name="serverUsername" value="<?=$username ? $username : ""?>" size="20" maxlength="30"
						onclick="clearField(this)"/>
						
				<label class="fLblRequest"><span class="required">*</span>MySQL Password: </label>
					<input type="password" name="serverPassword" value="<?=$password ? $password : ""?>" size="20" maxlength="30"
						onclick="clearField(this)"/>
	
				<label class="fLblRequest"><span class="required">*</span>MySQL Database: </label>
					<input type="text" name="serverDatabase" value="<?=$database ? $database : ""?>" size="20" maxlength="30"
						onclick="clearField(this)"/>

				<label class="fLblRequest">MySQL Socket: </label>
					<input type="text" name="serverSocket" value="<?=$socket ? $socket : ""?>" size="20" maxlength="30"
						onclick="clearField(this)"/>
				<br/>	
				<center>
